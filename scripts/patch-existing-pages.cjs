...
const DOMAIN = "https://magicalaurapainting.ca";
...
const blogPosts = {
 "blog/paint-prep-no-mess-guide.html": "/blog/paint-prep-no-mess-guide.html",
 "blog/when-to-repaint-interior.html": "/blog/when-to-repaint-interior.html",
 "blog/cabinet-painting-value.html": "/blog/cabinet-painting-value.html",
};
